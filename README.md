...
## Latest News
* 02/24/2026 [0.2.9](https://github.com/ModelCloud/PyPcre/releases/tag/v0.2.9): Allow VisualStudio (VS) compiler version check override using env var on Windows. 
